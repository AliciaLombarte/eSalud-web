	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(option){
			...
			case "login":
				...
				result = (Result) webResource.request("application/json").accept("application/json").post(Entity.entity(doctor,MediaType.APPLICATION_JSON),Result.class);
			...
			case "protocolos":
				...
				ListProtocolo protocolos = (ListProtocolo) webResource.request("application/json").accept("application/json").get(ListProtocolo.class);
			...
			case "cuestionarios":
				...
				ListCuestionario cuestionarios = (ListCuestionario) webResource.request("application/json").accept("application/json").get(ListCuestionario.class);
			...
			case "registro":
				...
				result = (Result) webResource.request("application/json").accept("application/json").post(Entity.entity(user,MediaType.APPLICATION_JSON),Result.class);
				...
				if(result.getResult() == 200){
				    ...
				    try {
				       ...
				       message.setContent("<p>Usted ha sido registrado como paciente en el sistema de HospitalApp, sus datos para iniciar sesión son:</p>"
				       		+ "<br><p> - Email: "+ to +" </p>" + "<p> - Contraseña: "+ password +"</p>" + "<br><p>La contraseña podrá ser modificada desde la aplicación pero requerirá de la original para su cambio.</p>"
				    		+ "<br><p>Un cordial saludo</p>","text/html");
			...
			case "infoUser":
				...
				ListWounds wound = (ListWounds) webResource.request("application/json").accept("application/json").post(Entity.entity(user,MediaType.APPLICATION_JSON),ListWounds.class);
			...
			case "createProtocol":
				...
				client = ClientBuilder.newClient();
				webResource = client.target("http://localhost:8081/cuestionarios");
				ListCuestionario cuestionarios2 = (ListCuestionario) webResource.request("application/json").accept("application/json").get(ListCuestionario.class);
			...
			case "protocol":
				...
				result = (Result) webResource.request("application/json").accept("application/json").post(Entity.entity(protocolo,MediaType.APPLICATION_JSON),Result.class);
				
				if(result.getResult() == 200){
					
					webResource = client.target("http://localhost:8081/protocolos");
					ListProtocolo protocolos1 = (ListProtocolo) webResource.request("application/json").accept("application/json").get(ListProtocolo.class);
